  ...
  if(isset($_SESSION['userdata'])){
    ...
    if (isset($_POST['submit']))
    {
        ...
        try {
          ...
          $mail->Body    = 'Here is the verification link <b><a href="http://localhost/cab/Home/login.php?verification='.$code.'">http://localhost/cab/Home/login.php?verification='.$code.'</a></b>';
